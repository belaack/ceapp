document.getElementById("chatbotBtn").addEventListener("click", function() {
  ...
  if (!chatContainer.innerHTML) {
      chatContainer.innerHTML = '<iframe allow="microphone;" width="350" height="430" src="https://console.dialogflow.com/api-client/demo/embedded/mvp-ceap-v1-bbyk"></iframe>';
  }
